...
<div class="navbar">
	...
	<div class="main">
        ...
        <a style="float:right" href="index.html" >Go Back</a><br>
        <script>
        ...
        <form name = "EmpRegister" action="EmpRegister" method="post" >
                ...
                <input type="text" id="empfn" name ="empfn" pattern= "{A-Za-z]" class = "form-control" required/><br>
                <label for="emplname">Last Name</label> 
                <input type="text" id="" name ="empln" pattern= "{A-Za-z]" class = "form-control" required/><br>
                <label for="title">Job Title</label> 
                <input type="text" id="title" name ="empjt" class = "form-control" required/><br>
		
                <strong>Birthdate (YYYY/MM/DD)</strong><br> 
                <input type="text" name="empby" pattern="[0-9]" class = "form-control" size="4" > /
								 <input type="text"  name="empbm" pattern="[0-9]" class = "form-control" size="2" > /
								  <input type="text"  name="empbd" pattern="[0-9]" class = "form-control" size="2" > <br> 
		
                <strong>Hiredate(YYYY/MM/DD)</strong><br> 
                <input type="text" name="emphy" pattern="[0-9]" class = "form-control" size="4"> /
								 <input type="text"  name="emphm" pattern="[0-9]" class = "form-control" size="2"> /
								  <input type="text" name="emphd" pattern="[0-9]" class = "form-control" size="2" /> <br>
                
                <label for="empssn">SSN</label> 
                <input type="text" id="empssn" name="empssn" size="9" pattern ="[0-9]" class = "form-control" required /><br>
                <label for="empdln">Drivers License Number</label> 
                <input type="text" id="empdln" name="empdln" maxlength="9" pattern ="[0-9]" class = "form-control" required /><br>
                <label for="empsal">Salary</label>
                <input type="text" id="empsal" name="empsal" pattern = "[0-9]" class = "form-control" required /><br>
		...
		<h3>Billing Address</h3>
                ...
                <input type="text" id="empzip" name ="empzip" size ="5" pattern ="[0-9]" class = "form-control" required/><br>
		...
		<h3>Contact Info</h3>
                ...
                <input type="text" id="empres" name="empres" size ="10" pattern = "[0-9]" class = "form-control" /><br>
                <label for="empcell">Cell</label> 
                <input type="text" id="empcell" name="empcell" size ="10" pattern = "[0-9]" class = "form-control" required/><br>
                <label for="empfax">Fax</label> 
                <input type="text" id="empfax" name="empfax" size ="10" pattern = "[0-9]" class = "form-control" ><br>
